...
public class Fox extends Animal {
    ...
    private static AnimalParameters parameters =  new AnimalParameters(
                  MAX_AGE, SEXUALLY_MATURE_AGE, BIRTH_PROPABILITY, BIRTH_COUNT);
    ...
    protected void actImpl() {
        ...
        // first hunt to clear neighbour field (more space for children)
        hunt(); 
